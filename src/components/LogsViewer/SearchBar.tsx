        ...
        <div className="ansi-search-container">
          <div className="ansi-search-input-wrapper">
            ...
            <div className="ansi-search-buttons">
              ...
              >
                <svg width="16" height="16" viewBox="1.5 3.5 12.5 8.5" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
          ...
          {hasFilter && (
            <button onClick={onClearSearch} className="ansi-clear-search">
              Clear
            </button>
          )}
        </div>
